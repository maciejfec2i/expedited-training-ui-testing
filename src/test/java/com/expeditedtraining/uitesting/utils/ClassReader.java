...
public class ClassReader {
     ...
     *
     * @param packageInstance The {@link Package} in which classes are to be discovered.
     * @return A {@link Map} of discovered classes.
     *
     * @author Maciej Fec
     * @version 10/05/2024
     */
    public static Map<String, String> getClassMapFrom(Package packageInstance) {
        try {
            return ClassPath
                    .from(Thread.currentThread().getContextClassLoader())
                    .getTopLevelClassesRecursive(packageInstance.getName())
                    .stream()
